...
import 'package:tasktimer/datamodel.dart';
...
class DoctorHomepageScreen extends StatefulWidget {
  ...
  DoctorHomepageScreen(this.name, this.mail, this.phone, this.spealist,
      this.about, this.address);
  @override
  State<DoctorHomepageScreen> createState() =>
      _DoctorHomepageScreenState(name, mail, phone, spealist, about, address);
}

class _DoctorHomepageScreenState extends State<DoctorHomepageScreen> {
  String name, mail, phone, spealist, about, address;
  _DoctorHomepageScreenState(this.name, this.mail, this.phone, this.spealist,
      this.about, this.address);
